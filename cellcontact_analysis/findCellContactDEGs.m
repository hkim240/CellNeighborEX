function findCellContactDEGs(outputFolder,center_celltype,cell_id,matchComb,neiCombUnique,matchMarker_var,clusterSelect,pvalue_total,pCutoff,logRatio_total,lrCutoff,log_data,log_data_zvalue,gene_name)
...
% if size(geneIndexTemp,1)>DEGnumber %delete:
...
%     cellSelect3FinalIDX = cellSelect3SortedIDX(1:DEGnumber-9); %delete:
