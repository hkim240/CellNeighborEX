...
# you can download 'Slide-seq_liver_cancer.csv' from the github page.
...
# get spatial map
#Slide-seq:(28,28)
CellNeighborEX.visualization.get_spatialPlot(df_bg, df_red, df_blue, df_black, label_red='TumorIII+Monocyte', label_blue='TumorIII', label_black='Monocyte', label_gene='F13a1', figsize=(28,28), save=True)